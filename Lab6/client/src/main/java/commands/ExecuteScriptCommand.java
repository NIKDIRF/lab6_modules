...
import exception.*;
import io.StudygroupScriptParser;
import io.UserIO;
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(fileName))){
            ...
            while (reader.ready()) {
                ...
                try {
                    ...
                    try {
                        Response response = application.communicateWithServer(commands, new StudygroupScriptParser(reader, userIO));
                    ...
                    } catch (StudyGroupReadException | StudyGroupBuildException | IllegalStateException ex) {
